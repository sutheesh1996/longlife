        ...
        <div class="main-panel">
          <div class="content-wrapper">
           ...
           <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4>Edit Device ID for {{ $user->name }}</h3>
<br>
                    <form action="{{ route('users.update-device', $user->id) }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="device_id">Device ID</label>
                            <input type="text" name="device_id" id="device_id" class="form-control"  value="{{ old('device_id', $user->device_id) }}" required>
                            @error('device_id')
